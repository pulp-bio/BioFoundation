...
"""
Test 33: FEMBA Tiny (True Architecture)
...
class FEMBATiny(nn.Module):
    ...
    def __init__(
        ...
        print(f"[FEMBATiny] Configuration:")
...
def test_model():
    ...
    print("=" * 70)
    print("Test 33: FEMBA Tiny (True Architecture)")
    print("=" * 70)
    ...
    if num_params > expected_params * 0.9 and num_params < expected_params * 1.1:
        ...
        print(f"\n[WARN] Parameter count {num_params:,} differs from expected ~7.6M")
