...
APAVA_CH_ORDER = ['C3','C4','F3','F4','F7','F8','Fp1','Fp2',
 'O1','O2','P3','P4','T3','T4','T5', 'T6'] # 16 channels


class APAVA_Dataset(torch.utils.data.Dataset):
    def __init__(self, hdf5_file, num_channels=16, finetune=False):
        self.hdf5_file = hdf5_file
        self.num_channels = num_channels
        self.channel_names = APAVA_CH_ORDER[: self.num_channels]
