...
MUMTAZ_CHN_ORDER = ['Fp1', 'F3', 'C3', 'P3', 'O1',
 'F7','T3', 'T5', 'Fz', 'Fp2',
 'F4','C4','P4','O2','F8',
 'T4','T6','Cz', 'Pz'] # 19 channels


class Mumtaz_Dataset(torch.utils.data.Dataset):
    def __init__(self, hdf5_file, num_channels=19, finetune=False):
        self.hdf5_file = hdf5_file
        self.num_channels = num_channels
        self.channel_names = MUMTAZ_CHN_ORDER[: self.num_channels]
